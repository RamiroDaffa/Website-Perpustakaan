...
function confirmDelete(id){
  ...
  if(confirmAction){
    window.location.href = "hapus-peminjaman.php?id=" + id;
 }
}
</script>
            ...
            <div class="page-content-wrapper">
              <div class="col-xl-12">
                ...
                <?php endif; ?>
                        <div class="row">
                          <div class="col-md-9">
                            <h4 class="header-title">Data Peminjam</h4>
                            <p class="card-title-desc">Berikut ini merupakan data
                              Peminjaman di Perpustakaan
                            </p>
                          </div>
                          <div class="col-md-3" style="text-align: right;">
                            <a href="tambah-Peminjaman.php" class="btn btn-info"><i class="fa fa-plus"></i> Input Data Peminjam</a>
                          </div>
                        </div>
                        ...
                        <table id="datatable-buttons"
                          ...
                          <tbody>
                            ...
                            while($peminjaman = mysqli_fetch_assoc($query)){
                              ...
                              echo "<td>";
                              echo "<a href='edit-peminjaman.php?id=".$peminjaman['id']."' class='btn btn-warning waves-effect waves-light'><i class='fas fa-pen'></i></a>";
                              echo "&nbsp;";
                              echo "<a onclick='confirmDelete(".$peminjaman['id'].")' class='btn btn-danger waves-effect waves-light'><i class='fas fa-trash-alt'></i></a>";
                              echo "</td>";
                              echo "</tr>";
                            }
                            ?>
